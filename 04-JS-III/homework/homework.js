...
function numeroMasGrande(numeros) {
  ...
  // Tu código:(version simple (funciona para arrays cortos))
  return Math.max.apply(null, numeros);
  ///version un poco mas extendida pero q compara los parametros uno a uno:
